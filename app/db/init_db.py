...
from app.services.features.catalog import MIRZABOT_FEATURE_FLAGS
...
def init_db():
    ...
    try:
        ...
        for k, v in {"welcome": "به ربات فروش VPN خوش آمدید 🌟", "payment_waiting": "رسید واریز را ارسال کنید.", "buy_success": "سرویس شما فعال شد ✅", "faq_general": "برای خرید، تمدید، دریافت لینک و پشتیبانی از منوی اصلی استفاده کنید."}.items():
        ...
        for i, (k, t) in enumerate(MIRZABOT_FEATURE_FLAGS):
